...
export interface NotificationServiceClient {
  ...
  countUnread(request: UserId): Observable<UnreadCount>;
}
...
export interface NotificationServiceController {
  ...
  countUnread(request: UserId): Promise<UnreadCount> | Observable<UnreadCount> | UnreadCount;
}

export function NotificationServiceControllerMethods() {
  return function (constructor: Function) {
    const grpcMethods: string[] = ["updateStatus", "findMany", "delete", "countUnread"];
